...
import com.memasyt.pocketHelper.fragments.GlobalQuestStatisticFragment;
import com.memasyt.pocketHelper.fragments.QuestFragment_oge;
import com.memasyt.pocketHelper.fragments.QuestFragment_oge_line;
import com.memasyt.pocketHelper.fragments.QuestFragment_oge_moreVotes;
import com.memasyt.pocketHelper.fragments.QuestFragment_oge_notVote;
    ...
    public void goGlobalQuest() {
        if(numberQuest_inTask <= 19) {
            ...
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.fragmentContainerView, new GlobalQuestStatisticFragment(yourAnswers),"statsGlobalOge")
                    .addToBackStack(null)
                    .commit();
        }
    }
