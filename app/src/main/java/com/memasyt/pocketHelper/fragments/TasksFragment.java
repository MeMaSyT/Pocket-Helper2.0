...
import com.memasyt.pocketHelper.exams.Exam;
import com.memasyt.pocketHelper.exams.ExamsAdapter;
...
public class TasksFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        examsList.add(new Exam(1, "oge_logo", "ОГЭ","#BC4B4B",
                "ОГЭ - экзамен, который сдают все школьники в конце 9 класса, данный тренажёр поможет вам к нему подготовиться",
